...
export function ServicePageView({
  ...
  return (
    <>
      <Box component="section" sx={{ py: { xs: 10, md: 14 }, px: 2 }}>
        <Container maxWidth="lg">
          ...
          <Typography
            variant="h2"
            component="h2"
            sx={{ fontWeight: 700, letterSpacing: "-0.03em", mb: 5 }}
          >
          ...
          >
            <Box sx={{ flex: { md: "0 0 320px" }, maxWidth: { md: 380 } }}>
              ...
              >
                Our process is structured yet adaptable. Every engagement is
                different, but we bring proven frameworks from years of GTM
                transformation and commercial excellence. Our experience is your
                asset.
              </Typography>
              <Box
                sx={{
      ...
      <Section
        title="Sales Operation and Commercial Execution"
        overline="SALES OPS & EXECUTION"
        alternate
      >
        <Box
          sx={{
