...
import { GTM_ITEMS, SALES_OPS_ITEMS, COMMERCIAL_EXEC_ITEMS, SUMMARY_BULLETS, SAP_ADVISORY_STEPS } from './data';
...
export default function ServicesPage() {
  return (
    <>
      <PageHero
        headline="Services"
        subheading="All services presented in accordion layout."
        showCta
        maxWidth="md"
      />
